...
<table class="tg table-marks">
    <tbody>
        <tr>
            <td class="tg-0pky head-table" colspan="6">Clientes</td>
            <td class="tg-0pky head-table" colspan="3">CI/Pasaporte</td>
            <td class="tg-0pky head-table" colspan="3">Telefono</td>
        </tr>
